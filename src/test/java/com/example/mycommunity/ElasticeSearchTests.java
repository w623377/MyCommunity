...
public class ElasticeSearchTests {
    @Autowired
    ...
    @Autowired
    private DiscussPostRepository discussRepository;//这个接口是用来操作es的，继承ElasticsearchRepository
    ...
    public void testElasticsearchService() {
        Page<DiscussPost> page = elasticsearchService.searchDiscussPost("互联网寒", 0, 10);
        System.out.println(page.getTotalElements());
        System.out.println(page.getTotalPages());
        System.out.println(page.getNumber());
        System.out.println(page.getSize());
